...
Here we an see that the reference group are vars with 4 cylinders. Why?

Interpretation of the coefficient must be made in comparison to the reference group (4 cyclinders), which is absorbed in the intercept coeficient. 
